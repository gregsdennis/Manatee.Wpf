...
namespace Manatee.Wpf.Converters
{
	...
	public class Aggregator : MarkupExtension, IValueConverter, IMultiValueConverter
	{
		...
		/// Creates a new instance of <see cref="Aggregator"/> and initializes with the passed converters.
		/// </summary>
		public Aggregator(IMultiValueConverter converter1, IValueConverter converter2)
		{
			Converters = new object[] {converter1, converter2};
		}
		/// <summary>
		/// Creates a new instance of <see cref="Aggregator"/> and initializes with the passed converters.
		/// </summary>
		public Aggregator(IMultiValueConverter converter1, IValueConverter converter2, IValueConverter converter3)
		{
			Converters = new object[] {converter1, converter2, converter3};
		}
		/// <summary>
		...
		/// Creates a new instance of <see cref="Aggregator"/> and initializes with the passed converters.
		/// </summary>
		public Aggregator(IMultiValueConverter converter1, IValueConverter converter2, IValueConverter converter3, IValueConverter converter4, IValueConverter converter5)
		{
			Converters = new object[] {converter1, converter2, converter3, converter4, converter5};
		}
